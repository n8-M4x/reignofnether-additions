...
public class ReignOfNetherCommonConfigs {
    ...
    static {
        ...
        BuildingCosts.MONSTER_MINE.define(BUILDER);
        BuildingCosts.MONSTER_WALL.define(BUILDER);
        ...
        BuildingCosts.VILLAGER_MINE.define(BUILDER);
        BuildingCosts.VILLAGER_WALL.define(BUILDER);
        ...
        BuildingCosts.PIGLIN_MINE.define(BUILDER);
        BuildingCosts.PIGLIN_WALL.define(BUILDER);
    ...
    public static class BuildingCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry MONSTER_MINE = ResourceCostConfigEntry.Building(200,250,100, 0, ResourceCosts.VILLAGER_MINE, "Monster Mine Config");
        public static final ResourceCostConfigEntry MONSTER_WALL = ResourceCostConfigEntry.Building(0,120,100, 0, ResourceCosts.VILLAGER_WALL, "Monster Wall Config");
        ...
        public static final ResourceCostConfigEntry VILLAGER_MINE = ResourceCostConfigEntry.Building(200,250,100, 0, ResourceCosts.VILLAGER_MINE, "Villager Mine Config");
        public static final ResourceCostConfigEntry VILLAGER_WALL = ResourceCostConfigEntry.Building(0,120,100, 0, ResourceCosts.VILLAGER_WALL, "Villager Wall Config");
        ...
        public static final ResourceCostConfigEntry PIGLIN_MINE = ResourceCostConfigEntry.Building(200,250,100, 0, ResourceCosts.PIGLIN_MINE, "Piglin Mine Config");
        public static final ResourceCostConfigEntry PIGLIN_WALL = ResourceCostConfigEntry.Building(0,120,100, 0, ResourceCosts.PIGLIN_WALL, "Piglin Wall Config");
    }
